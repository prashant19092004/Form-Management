  ...
  <div class="flex flex-row pt-24 px-10 pb-4">
    <div class="w-2/12 mr-6">
      <div class="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
        <Link to="/admin/" class="inline-block text-gray-600 hover:text-black my-4 w-full">
          <span class="material-icons-outlined float-left pr-2">dashboard</span>
          Home
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </Link>
        <Link to="/admin/batches" class="inline-block text-gray-600 hover:text-black my-4 w-full">
      ...
      <Link to="/admin/trainers" class="inline-block text-gray-600 hover:text-black my-4 w-full">
        ...
        <Link to="/admin/record" class="inline-block text-gray-600 hover:text-black my-4 w-full">
